...
def populate():
    ...
    python_pages = [
        {'title': 'Official Python Tutorial','url':'http://docs.python.org/3/tutorial/', 'views':37},
    ...
    django_pages = [
        ...
        {'title':'Django Rocks', 'url':'http://www.djangorocks.com/', 'views':51},
        {'title':'How to Tango with Django','url':'http://www.tangowithdjango.com/', 'views':28}
        ]


    other_pages = [
        {'title':'Bottle', 'url':'http://bottlepy.org/docs/dev/', 'views':82},
